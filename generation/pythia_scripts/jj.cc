...
int main()
{
  ...
  pythia.readString("Beams:LHEF = /mnt/48D4698ED4697ED6/Python/MSc_Project_Upgrade/generation/LHE_files/ee_jj_250GeV_80k_train.lhe");
  ...
  HepMC3::WriterAscii writer(
      "/mnt/48D4698ED4697ED6/Python/MSc_Project_Upgrade/generation/hepmc_files/ee_jj_250GeV_80k_train.hepmc");
